...
class Hang:
    ...
    def __init__(self):
        ...
        self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img1.jpeg")
    ...
    def button_name(self):
        ...
        # So, in order to fix it we should change END to end-1c. The -1c deletes 1 character
    ...
    def button_guess(self):
        ...
        if self.turn < 6:
            ...
            if self.turn == 0:
                ...
                self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img2.jpeg")
            elif self.turn == 2:
                self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img3.jpeg")
            elif self.turn == 3:
                self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img4.jpeg")
            elif self.turn == 4:
                self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img5.jpeg")
            elif self.turn == 5:
                self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img6.jpeg")
            elif self.turn == 6:
                self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img7.jpeg")

            if self.turn < 6:
                result.set(("You", "have", 6 - self.turn, "tries", "Left"))

            else:
                self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img.lose.jpeg")
                result.set("You Lose")

            if failed == 0:
                self.image1 = Image.open("C:/Users/User Bill/Desktop/IPP Project/img.win.jpeg")
                result.set("You Win")
            text.delete("1.0", "end")
        else:
            result.set("You Lose")
